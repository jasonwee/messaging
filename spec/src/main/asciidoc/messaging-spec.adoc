...
An asynchronous send is not permitted in a Jakarta EE web contaienr or Enterprise Beans container.
...
=== Version 3.0
* namespace changed from javax to jakarta
...
==== Clarification: message headers that are intended to be set by the Jakarta Messaging provder (JMS_SPEC-34)
